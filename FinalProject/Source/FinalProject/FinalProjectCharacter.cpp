...
AFinalProjectCharacter::AFinalProjectCharacter()
{
	...
	// Setting the Walk Speed and Sprint Speed 
	WalkSpeed = 200;
	SprintSpeed = 500;
...
void AFinalProjectCharacter::NotifyControllerChanged()
{
...
void AFinalProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Sprinting 
		EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Triggered, this, &AFinalProjectCharacter::StartSprint); // for when shift is pressed
		EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Completed, this, &AFinalProjectCharacter::StopSprint); // for when shift is released
	}
	else
	{
...
void AFinalProjectCharacter::StartSprint() {
	GetCharacterMovement()->MaxWalkSpeed = SprintSpeed;
}

void AFinalProjectCharacter::StopSprint() {
	GetCharacterMovement()->MaxWalkSpeed = WalkSpeed;
}
